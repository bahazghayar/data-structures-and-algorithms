...
function returnTen(str) {
  // Solution code here...
  let arr1A = str.split('');
  let arr1B = arr1A.splice(arr1A.length - 10, arr1A.length);
  return arr1B;
}
...
const typeNum = (arr) => {
  ...
  let arr2 = arr.filter(function (n, i) {
...
const containsAnd = (arr) => {
  // Solution code here...
  let arr3 = arr.filter(function (n, i) {
...
const oddValues = (arr) => {
  // Solution code here...
  let arr4 = arr.filter(function (n, i) {
    return (n % 2);
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let arr6 = arr.filter(function (n) {
