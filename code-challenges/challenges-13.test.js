...
const standardizePhoneNumbers = (arr) => {
  ...
  let arr4 = [];
  arr.forEach(val => {
    let firstPart = val.substring(1, 4);
    let secPart = val.substring(6, 9);
    let thirdPart = val.substring(10, 14);
    arr4.push(firstPart + secPart + thirdPart);
  });
